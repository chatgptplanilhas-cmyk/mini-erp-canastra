      ...
      <>
        <section className="sticky top-0 z-40 bg-[#15110f]/95 backdrop-blur border border-orange-950 rounded-[28px] p-5 mb-6 shadow-2xl">
          ...
          <form onSubmit={salvarVenda} className="grid grid-cols-12 gap-3 items-end">
            ...
            <button type="submit" className="col-span-1 bg-orange-950 hover:bg-orange-900 rounded-2xl px-4 py-3 text-sm font-semibold transition">
              {editandoVendaId ? 'Salvar' : 'Lançar'}
            </button>

            <button type="button" onClick={limparVenda} className="col-span-1 bg-zinc-800 hover:bg-zinc-700 rounded-2xl px-4 py-3 text-sm font-semibold transition">
              Limpar
            </button>
          </form>
        </section>
      ...
      <section className="bg-black border border-orange-950 rounded-[28px] p-8">
        <div className="flex items-center justify-between gap-4 mb-6">
          ...
          <input
            ...
            className="w-[440px] bg-zinc-950 border border-zinc-800 rounded-2xl p-4"
          />
        </div>
        ...
        <form onSubmit={salvarDelivery} className="grid grid-cols-4 gap-4 mb-8">
          <select
...
01 Doce de leite`}
            rows={5}
            className="col-span-2 bg-zinc-950 border border-zinc-800 rounded-2xl p-4 resize-y min-h-[140px] leading-relaxed"
          />
          ...
          <button className="col-span-3 bg-orange-950 hover:bg-orange-900 rounded-2xl p-4 font-semibold">
          ...
          {editandoDeliveryId && (
            <button
              ...
              className="col-span-4 bg-zinc-800 hover:bg-zinc-700 rounded-2xl p-4 font-semibold"
            >
              Cancelar edição
            </button>
          )}
