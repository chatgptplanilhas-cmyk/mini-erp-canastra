      ...
      <div className="flex flex-col lg:grid lg:grid-cols-[280px_1fr]">
        <div className="lg:hidden sticky top-0 z-50 bg-black border-b border-orange-950 p-3">
          ...
          <nav className="flex gap-2 overflow-x-auto pb-1">
            ...
            {botaoMenu('clientes', 'ðŸ‘¤', 'Clientes')}
            {botaoMenu('vendas', 'ðŸ§¾', 'Vendas')}
            {botaoMenu('pendencias', 'ðŸ’°', 'PendÃªncias')}
            {botaoMenu('pagamentos', 'ðŸ’³', 'Pagamentos')}
            {botaoMenu('delivery', 'ðŸšš', 'Delivery')}
            {botaoMenu('produtos', 'ðŸ§€', 'Produtos')}
            {botaoMenu('produtos-controle', 'ðŸ“¦', 'Controle')}
            {botaoMenu('fornecedores', 'ðŸšš', 'Fornecedores')}
            {botaoMenu('despesas', 'ðŸ§¾', 'Despesas')}
            {botaoMenu('taxas', 'âš™ï¸', 'Taxas')}
          </nav>
        </div>
