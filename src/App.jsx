                    ...
                    <article key={pendencia.id} className="mini-cobranca-operacional rounded-2xl border border-zinc-900 bg-black p-4">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <p className={`text-lg font-black ${statusAtual.classe}`}>{dataBR(pendencia.vencimento)}</p>
                          <span className={`inline-flex mt-1 px-3 py-1 rounded-xl text-xs font-bold ${statusAtual.badge}`}>{statusAtual.texto}</span>
                        </div>
                        <div>
            ...
            >
              <div className="mini-pendencia-clean-head">
                ...
                <div className="mini-pendencia-clean-saldo">
                  <span>Saldo</span>
                  <strong>{moeda(pendencia.saldo_restante)}</strong>
                </div>
              </div>
              ...
              <div className="mini-pendencia-clean-info">
                ...
                <div>
                  ...
                  <strong className="text-green-300">{dataBR(pendencia.vencimento)}</strong>
                </div>

                <div>
                  <span>Status</span>
                  <strong className="mini-pendencia-status-clean">{normalizarStatus(pendencia.status)}</strong>
                </div>
              ...
              <div className="mini-pendencia-clean-actions">
                <button onClick={() => cobrarWhatsApp(pendencia)} className="bg-emerald-700 hover:bg-emerald-600">
                  Cobrar
                </button>

                <button onClick={() => registrarPagamento(pendencia.venda_id, pendencia.saldo_restante, pendencia)} className="bg-green-700 hover:bg-green-600">
                  Registrar
                </button>

                <button onClick={() => registrarPagamento(pendencia.venda_id, pendencia.saldo_restante, pendencia)} className="bg-zinc-700 hover:bg-zinc-600 mini-pendencia-action-wide">
                  Confirmar pagamento
                </button>

                <button onClick={() => editarPendenciaFinanceira(pendencia)} className="bg-orange-950 hover:bg-orange-900 mini-pendencia-action-wide">
                  Editar pendência
                </button>
