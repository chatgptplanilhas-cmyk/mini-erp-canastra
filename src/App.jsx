    ...
    return (
      <>
        <section className="bg-black border border-orange-950 rounded-[28px] p-8 mb-6">
          ...
          <form onSubmit={salvarVenda} className="grid grid-cols-6 gap-4">
            <div>
            ...
            <div className="col-span-6 grid grid-cols-3 gap-4">
              <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                <p className="text-zinc-500 mb-2">Taxa aplicada</p>
                <p className="text-2xl font-bold text-orange-300">{percentual(percentualTaxa)}</p>
              </div>

              <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                <p className="text-zinc-500 mb-2">Valor da taxa</p>
                <p className="text-2xl font-bold text-red-300">{moeda(valorTaxa)}</p>
              </div>

              <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5">
                <p className="text-zinc-500 mb-2">Valor líquido</p>
                <p className="text-2xl font-bold text-green-300">{moeda(valorLiquido)}</p>
              </div>
            </div>

            <button type="submit" className="col-span-5 bg-orange-950 hover:bg-orange-900 rounded-2xl p-4 font-semibold transition">
              {editandoVendaId ? 'Salvar edição' : 'Salvar venda'}
            </button>

            <button type="button" onClick={limparVenda} className="bg-zinc-800 hover:bg-zinc-700 rounded-2xl p-4 font-semibold transition">
              Limpar
            </button>
          </form>
        </section>
  ...
  function TelaClientes() {
    ...
    return (
      <section className="bg-black border border-orange-950 rounded-[28px] p-8">
        ...
        <form onSubmit={salvarCliente} className="grid grid-cols-4 gap-4 mb-8">
    ...
    return (
      <section className="bg-black border border-orange-950 rounded-[28px] p-8">
        ...
        <form onSubmit={salvarProduto} className="grid grid-cols-6 gap-4 mb-8">
          ...
          {editandoProdutoId && (
            <button type="button" onClick={limparProduto} className="col-span-6 bg-zinc-800 hover:bg-zinc-700 rounded-2xl p-4 font-semibold">
              Cancelar edição
            </button>
          )}
        </form>
      ...
      <section className="bg-black border border-orange-950 rounded-[28px] p-8">
        ...
        <form onSubmit={salvarFornecedor} className="grid grid-cols-6 gap-4 mb-8">
          ...
          {editandoFornecedorId && (
            <button type="button" onClick={limparFornecedor} className="col-span-6 bg-zinc-800 hover:bg-zinc-700 rounded-2xl p-4 font-semibold">
              Cancelar edição
            </button>
          )}
        </form>
        ...
        <form onSubmit={salvarDespesa} className="grid grid-cols-6 gap-4 mb-8">
          ...
          {editandoDespesaId && (
            <button
              ...
              className="col-span-6 bg-zinc-800 hover:bg-zinc-700 rounded-2xl p-4 font-semibold"
            >
              Cancelar edição
            </button>
          )}
  ...
  return (
    <div className="min-h-screen bg-[#15110f] text-white">
      <div className="grid grid-cols-[280px_1fr]">
        <aside className="min-h-screen bg-black border-r border-orange-950 p-6">
          <div className="mb-10">
