...
\restrict CQbSaPd5D6zUJcKnn60gfEzVXz6LoT3O22GCbmaDNr6djNep5uARKMlC0ceReNV
...
COPY public.pendencias (id, venda_id, vencimento, saldo_restante, status, dias_atraso, created_at) FROM stdin;
...
SELECT pg_catalog.setval('public.delivery_id_seq', 15, true);
...
\unrestrict CQbSaPd5D6zUJcKnn60gfEzVXz6LoT3O22GCbmaDNr6djNep5uARKMlC0ceReNV
